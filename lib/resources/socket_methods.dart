...
class SocketMethods {
  ...
  void endGameListener(BuildContext context) {
    _socketClient.on('endGame', (playerData) {
      showGameDialog(context, '${playerData['nickname']} gano el juego!');
      Navigator.popUntil(context, (route) => false);
    });
  }

  void _updateChatMessages(dynamic chatMessages) {
  ...
  void sendMessage(String message) {
    if (message.isNotEmpty) {
      _socketClient.emit('chatMessage', {
        'text': message,
        'isUser': true,
      });
    }
  ...
  void chatMessageListener(BuildContext context) {
    _socketClient.on('chatMessage', (message) {
